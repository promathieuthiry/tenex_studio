...
export function Footer({ locale }: { locale: Locale }) {
  return (
    <footer className="mt-32 border-t border-ink/10 bg-paper px-6 py-16 md:px-10 md:py-24">
      <div className="mx-auto grid max-w-screen-xl gap-12 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr]">
        <div>
        ...
        <div className="flex flex-col gap-3">
          <p className="font-mono text-xs uppercase tracking-[0.12em] text-ink/50">
            {FOOTER.newsletter.heading[locale]}
          </p>
          <p className="font-sans text-sm text-ink/70">
            {FOOTER.newsletter.description[locale]}
          </p>
