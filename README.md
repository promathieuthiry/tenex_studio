...
Design references saved as inspiration sources:
...
- [Eleven Labs](https://eleven-labs.com/)
...
- [MDX](https://mdx.so/)
- [Thibault Guignand (Codrops)](https://tympanus.net/codrops/author/thibaultguignand/)
